...
%% Copied from commands.tex of the original template
%% Conditional commands
% Define a command to check if a command is defined
\newcommand{\IfDefinedBibEnvironment}[1]{\ifcsdef{blx@env@#1}}
\IfUndefined{phantomsection}{\providecommand\phantomsection{}}
